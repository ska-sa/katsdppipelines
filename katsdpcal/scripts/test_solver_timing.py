...
def parse_opts():
    ...
    parser.add_argument('-n', '--niter', type=int, default=100,
                        help='Number of iterations for timer.')
    parser.add_argument('--file', type=str, default='',
                        help='File for simulated data (H5).')
    parser.add_argument('--nants', type=int, default=7,
                        help='Number of antennas for simulated array (if no file is provided).')
    parser.add_argument('--nchans', type=int, default=1,
                        help='Number of channels for simulated array (if no file is provided).')
    parser.add_argument('--noise', action='store_true',
                        help='Add noise to simulated data (if no file is provided).')
