...
def pipeline(parmFile, h5file):
    ...
    * *h5file* = h5 filename
    ...
    cls = "LRaw"
    seq = 1
    uv=OTObit.uvlod(ffdirs[0]+"/KAT7Template.uvtab",0,nam,cls,1,seq,err)
...
if __name__ == '__main__':
    usage = """usage: %prog [options] PipelineParms h5fileToImage
